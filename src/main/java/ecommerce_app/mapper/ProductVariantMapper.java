...
public class ProductVariantMapper {
  ...
  public ProductVariantResponse toResponse(ProductVariant variant) {
    ...
    List<ProductVariantResponse.AttributeValueDto> attrDtos =
        variant.getAttributeValues() == null
            ...
            : variant.getAttributeValues().stream().map(this::toAttributeValueDto).toList();
  ...
  // ── Private helpers ──────────────────────────────────────────────
  private ProductVariantResponse.AttributeValueDto toAttributeValueDto(
      ProductAttributeValue value) {
    return ProductVariantResponse.AttributeValueDto.builder()
        .id(value.getId())
        .attribute(
            value.getProductAttribute() != null
